                ...
                <div className="relative flex flex-col items-center justify-center z-20">
                    <div className="absolute top-0 left-0 flex items-center justify-center">
                        <Image
                            ...
                            height={200}
                        />
                        <div className={`${NauSea.className} text-4xl`}><span>Solana spin</span> - <span>Demo</span><sup title="lomre ipsum sin dolor xxx sdfsd">I</sup></div>
                    </div>
                    <Jackpot/>
                </div>
                        ...
                        <div className="flex items-center">
                            <div className="flex flex-row justify-center items-center">
                                {predefinedBets.map((bet: number, i: number) => (
                                    <div
                                        className={clsx(
                                            "p-2 m-2 text-xl rounded-xl w-16 h-16 font-bold flex items-center justify-center bg-[url('/images/woody-button2.webp')] bg-cover bg-no-repeat",
                                ...
                                <div
                                    className="font-bold text-2xl text-yellow-300 ml-3 border-1 border-solid border-yellow-500 p-2 rounded"> {formatCurrency(balance)}</div>
                            </div>
                        </div>
                    </div>
                </div>
